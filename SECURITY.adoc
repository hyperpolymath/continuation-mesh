...
[arabic]
. Navigate to
https://github.com/hyperpolymath/bag-of-actions/security/advisories/new[Report
a Vulnerability]
...
* This repository (`+hyperpolymath/bag-of-actions+`) and all its code
...
https://github.com/hyperpolymath/bag-of-actions/security/advisories[Security
Advisories]
...
When using Bag Of Actions, we recommend:
...
|*General questions*
|https://github.com/hyperpolymath/bag-of-actions/discussions[GitHub
Discussions]
...
_Thank you for helping keep Bag Of Actions and its users safe._ 🛡️
